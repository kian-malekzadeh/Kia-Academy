...
- **GitHub Pages (demo mode):** push `main` → `Deploy GitHub Pages` workflow exports the static app to `/Kia-Academy/`. Live at <https://kian-malekzadeh.github.io/Kia-Academy/>
